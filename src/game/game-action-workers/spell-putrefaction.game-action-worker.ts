 ...
 */
export class SpellPutrefactionGameActionWorker extends GameActionWorker {

  static readonly TYPE: string = 'spell-putrefaction';
  ...
  public async create(gameInstance: IGameInstance, data: {user: number}): Promise<IGameAction> {
    return {
      createdAt: Date.now(),
      type: SpellPutrefactionGameActionWorker.TYPE,
      description: {
        en: ``,
