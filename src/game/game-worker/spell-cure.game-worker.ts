...
/**
 * Main worker for "cure" spell.
 */
@Injectable() // Injectable required here for dependency injection
export class SpellCureGameWorker implements IGameWorker, IHasGameHookService {
  ...
  readonly type: string = 'spell-cure';
  ...
  public async create(gameInstance: IGameInstance, data: {user: number}): Promise<IGameAction<ISubActionPutCardOnBoard>> {
    return {
      ...
      description: {
        en: ``,
        fr: `Jouer un remène sur un sorcier`,
      },
