...
export interface IGameWorker {
   ...
   * @param gameAction
   */
  refresh(gameInstance: IGameInstance, gameAction: IGameAction): Promise<void>;
   ...
   * @param gameAction
   */
  execute(gameInstance: IGameInstance, gameAction: IGameAction): Promise<boolean>;
   ...
   * @param gameAction
   */
  expires(gameInstance: IGameInstance, gameAction: IGameAction): Promise<boolean>;
   ...
   * @param gameAction
   */
  delete(gameInstance: IGameInstance, gameAction: IGameAction): Promise<void>;
}
