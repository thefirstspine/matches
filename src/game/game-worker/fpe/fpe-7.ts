...
export class Fpe7GameWorker implements IGameWorker, IHasGameHookService, IHasGameWorkerService {

  public gameHookService: GameHookService;
  public gameWorkerService: GameWorkerService;

  public readonly type: string = 'fpe-7';
      ...
      subactions: [
        {
          type: 'accept',
          description: {
            fr: `Profites-en également pour avancer ta Banshee pour mettre la pression sur ton adversaire.`,
            en: ``,
          },
          params: {
          },
        },
        {
          type: 'accept',
          description: {
            fr: `Une fois fait, cliques en haut sur "Passer" pour aller à la phase de confrontations.`,
            en: ``,
          },
          params: {
          },
  ...
  public async execute(gameInstance: IGameInstance, gameAction: IGameAction): Promise<boolean> {
    // Add next the action
    const action: IGameAction = await this.gameWorkerService.getWorker('fpe-8').create(gameInstance, {user: gameAction.user});
