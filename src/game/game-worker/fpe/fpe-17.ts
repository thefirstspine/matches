...
import { IGameInstance, IGameAction, ISubActionPutCardOnBoard, IGameCard, anySubaction } from '../../../@shared/arena-shared/game';
...
/**
 * Worker for "ruin" spell.
 */
@Injectable() // Injectable required here for dependency injection
export class Fpe17GameWorker implements IGameWorker, IHasGameHookService, IHasGameWorkerService {

  public gameHookService: GameHookService;
  public gameWorkerService: GameWorkerService;

  readonly type: string = 'fpe-17';
  ...
  public async execute(gameInstance: IGameInstance, gameAction: IGameAction<ISubActionPutCardOnBoard>): Promise<boolean> {
    ...
    // Add next the action
    const action: IGameAction<any> = await this.gameWorkerService.getWorker('fpe-18').create(gameInstance, {user: gameAction.user});
