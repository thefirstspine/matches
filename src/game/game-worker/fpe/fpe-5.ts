...
export class Fpe5GameWorker implements IGameWorker, IHasGameHookService, IHasGameWorkerService {

  public gameHookService: GameHookService;
  public gameWorkerService: GameWorkerService;

  public readonly type: string = 'fpe-5';
      ...
      subactions: [
        {
          type: 'accept',
          description: {
            fr: `Places le Totem Fûmant au-dessus de la Banshee ennemie.`,
            en: ``,
          },
          params: {
          },
        },
        {
          type: 'accept',
          description: {
            fr: `Le Totem Fûmant a une capacité sur son côté inférieur qui permet d'entrer en confrontation à la fin de ton tour.`,
            en: ``,
          },
          params: {
          },
